...
impl EntityEditor {
            ...
            egui::Window::new("Entity").show(&gui.ctx, |ui| {
                ...
                if let Some(b_box) = registry.entities.get_mut::<CBoundingBox>(&entity) {
                    ui.collapsing("Bounding Box", |ui| {
                        ...
                        ui.horizontal(|ui| {
                            ui.label("near");
                            ui.add(egui::DragValue::new(&mut b_box.near).speed(1.0));
                            ui.label("far");
                            ui.add(egui::DragValue::new(&mut b_box.far).speed(1.0));
                        });
                    });
                }
    ...
    fn add_component(
        ...
        ui.menu_button("Add component", |ui| {
            ...
            if registry.entities.get::<CBoundingBox>(&entity).is_none() {
